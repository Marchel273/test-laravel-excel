...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control <?php $__errorArgs = ['room_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                        ...
                        <option value="standard" <?php echo e(old('room_type', $room->room_type) == 'standard' ? 'selected' : ''); ?>>Standard</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>" 
                           id="price" name="price" value="<?php echo e(old('price', $room->price)); ?>" min="0" step="0.01" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3">
                    ...
                    <?php if($room->photo): ?>
                        <div class="mb-2">
                            <img src="<?php echo e(Storage::url($room->photo)); ?>" alt="Current Photo" width="100" class="img-thumbnail">
                            <br>
...
unset($__errorArgs, $__bag); ?>
                ...
                <a href="<?php echo e(route('rooms.index')); ?>" class="btn btn-secondary">Batal</a>
            </form>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\TelUHotel\resources\views/rooms/edit.blade.php ENDPATH**/ ?>